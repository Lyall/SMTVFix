...
bool UAtomStatics::GetForceCreateAtomComponent()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AtomStatics", "GetForceCreateAtomComponent");

	Params::AtomStatics_GetForceCreateAtomComponent Parms{};
...
void UAtomStatics::SetForceCreateAtomComponent(bool Enable)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AtomStatics", "SetForceCreateAtomComponent");

	Params::AtomStatics_SetForceCreateAtomComponent Parms{};
...
bool UManaPlayer::OpenPlaylistIndex(class UManaPlaylist* InPlaylist, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
