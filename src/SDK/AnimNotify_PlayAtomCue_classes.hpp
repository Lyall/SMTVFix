...
public:
	...
	uint8                                         Pad_65FE[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          SyncPlaybackSpeed;                                 // 0x0054(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(UPlayAtomCue_C, SyncPlaybackSpeed) == 0x000054, "Member 'UPlayAtomCue_C::SyncPlaybackSpeed' has a wrong offset!");
